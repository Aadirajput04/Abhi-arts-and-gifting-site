...
<body>
    ...
    ?>
        <div class="hero-content side-padding">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas odio magna, suscipit eget leo <br>
                quis,
                fermentum condimentum metus. Pellentesque habitant morbi tristique.</p>
            <a href="#">Contact Now <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                    fill="none">
                    <path
    ...
    include "our-product-section.php";
